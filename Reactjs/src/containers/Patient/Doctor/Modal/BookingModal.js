  ...
  buildDataGender = (data) => {
   ...
   async componentDidUpdate(prevProps, prevState, snapshot){
    ...
    buildTimeBooking = (dataTime) => {
        ...
        console.log('hoidanit check inside rendertimebooking: ', dataTime)
      ...
      >
       <div className="booking-modal-content">
           ...
           <div className="booking-modal-footer">
               ...
               <button className="btn-booking-cancel" onClick={closeBookingClose}> <FormattedMessage id="patient.booking-modal.cancel"/></button>
           </div>
       </div>
